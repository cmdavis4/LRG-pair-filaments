...
def casjobs(gal_cat, casjobs_info):
    ...
    job_info = {'full_jobname':full_jobname,
                ...
                'casjobs':casjobs,
                'chunknum':casjobs_info['chunknum'],
...
if __name__ == "__main__":
    ...
    casjobs_info.update({'cas_jar_path':'../casjobs_query/casjobs.jar',
    ...
    gal_cat = {'filename':'test_raw_spectro_%d.cat' %chunknum,
               'data_dir':'./data/',
               'out_file':'test_spectro_%d.cat' %chunknum
           }
